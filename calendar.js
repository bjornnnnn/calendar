...
let events = [
    ...
    */
    ...
    { dayOfYear: 154, name: "Kölbåt: onsdagssegling 1 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 161, name: "Kölbåt: onsdagssegling 2 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 168, name: "Kölbåt: onsdagssegling 3 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 175, name: "Kölbåt: onsdagssegling 4 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 182, name: "Kölbåt: onsdagssegling 5 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 189, name: "Kölbåt: onsdagssegling 6 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 196, name: "Kölbåt: onsdagssegling 7 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 203, name: "Kölbåt: onsdagssegling 8 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 210, name: "Kölbåt: onsdagssegling 9 (prel)",                      scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 217, name: "Kölbåt: onsdagssegling 10 (prel)",                     scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 224, name: "Kölbåt: onsdagssegling 11 (prel)",                     scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 231, name: "Kölbåt: onsdagssegling 12 (prel)",                     scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 238, name: "Kölbåt: onsdagssegling 13 (prel)",                     scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 245, name: "Kölbåt: onsdagssegling 14 (prel)",                     scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 252, name: "Kölbåt: onsdagssegling 15 (prel)",                     scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 259, name: "Kölbåt: onsdagssegling 16 (prel)",                     scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
    { dayOfYear: 266, name: "Kölbåt: onsdagssegling 17 (prel) - Säsongsavslutning", scope: "Club", boats: ["Kölbåt SRS", "Jolle SRS"], when: "18:00 - 21:00", where: geosites.nyn_havsbad_ens, responsible: users.bjon, what: "Kappsegling SRS med egen app (klubbsegling.se). Start- och mållinje: enslinje flagga på NHSS brygga och femknopsskylt.", label: "nssEvent" },
